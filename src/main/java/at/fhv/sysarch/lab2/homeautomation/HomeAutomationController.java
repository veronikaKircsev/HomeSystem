...
public class HomeAutomationController extends AbstractBehavior<Void>{
    ...
    private  HomeAutomationController(ActorContext<Void> context) {
        ...
        ActorRef<Void> ui = getContext().spawn(UI.create(this.tempSensor, this.airCondition, this.mediaStation,
                this.fridge, this.temperatureEnvironment , this.fridgeOpticEnvironment, this.weatherEnvironment, this.weatherSensor, this.blinds), "UI");
